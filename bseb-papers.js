/* ==========================================================================
   ...
   Instruction: सिर्फ driveLink और answerKey के विकल्प (A, B, C, D) बदलें।
   ========================================================================== */
...
const BSEB_PAPERS_DATABASE = {
  ...
  "101-hindi": {
    ...
    hasPractical: false,
    totalPages: 23,
    // गूगल ड्राइव का प्रीव्यू लिंक (यहाँ अपना 1 लिंक पेस्ट करें)
    driveLink: "https://drive.google.com/file/d/1Bg2tRMt4gIDKkFnpc6urG953b9AYz2hC/preview",
    // 100 ऑब्जेक्टिव प्रश्नों के सही उत्तर (1 प्रश्न = 1 अंक)
    answerKey: {
      1: "A", 2: "C", 3: "B", 4: "D", 5: "A",
  ...
  "112-science": {
    ...
    fullMarks: 100, // 80 Theory + 20 Practical
    passMarks: 30,
    hasPractical: true,
    practicalMarks: 20,
    totalPages: 24,
